import {AnswerCardPage} from "./core/block/layout/answerCardPage.js";
import {AnswerCardConverter} from "./converter/answerCardConverter.js";
import {DynaPageSizerRenderBuilder} from "../../../js/dynaPageSizerRender/core/dynaPageSizerRenderBuilder.js";

var AnswerCardDynaPageSizerRender = window.AnswerCardDynaPageSizerRender = {
	paperInfo: {},
	dynaPageSizerRender: {},
	async init() {
		this.initTestData();
	...
	async initDynaPageSizerRender() {
		var buildAnswerCardDynaPageSizerRender = this.initBuildDynaPageSizerRender();
		this.dynaPageSizerRender = await buildAnswerCardDynaPageSizerRender.init();
	},
	initBuildDynaPageSizerRender() {
		var buildAnswerCardDynaPageSizerRender = new DynaPageSizerRenderBuilder("answer_card_root", AnswerCardPage, AnswerCardConverter, this.buildConverterData(), this.changeDomCallback);
		buildAnswerCardDynaPageSizerRender.getMoveOverHtmlUnableSplitClass = this.getMoveOverHtmlUnableSplitClass;
		return buildAnswerCardDynaPageSizerRender;
	},
